...
//
// NOTE (latest check): `qwen/qwen3.6-27b` now returns
// `404 model_not_found` — Groq replaced it with `qwen/qwen3.8-27b`, which is
// verified available on this key and returns clean JSON under
